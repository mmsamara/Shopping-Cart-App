...
namespace MuhammadShoppingCart.Controllers
{
    ...
    {
        //Private member called db which is an instance of the ApplicationDbContext
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: OrderDetails
        public ActionResult Index()
        {
            //This is called an eager load
            var orderDetails = db.OrderDetails.Include(o => o.Item).Include(o => o.Order);
            //Another way to write that same line:
            //var orderDetails = db.OrderDetails.Include("Item").Include("Order");
        ...
        {
            //You should probably never create any order details manually. It will be created through the scaffolding process
